        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/admin/referrals">
            <Card className="bg-white border-gray-200 hover:border-emerald-300 transition-colors cursor-pointer h-full">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900">Referral Management</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-600">Manage referral codes and earnings</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/admin/fraud-detection">
            <Card className="bg-white border-gray-200 hover:border-emerald-300 transition-colors cursor-pointer h-full">
              ...
              <CardContent>
                <p className="text-sm text-gray-600">Monitor and flag suspicious activity</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/admin/announcements">
            <Card className="bg-white border-gray-200 hover:border-emerald-300 transition-colors cursor-pointer h-full">
              ...
              <CardContent>
                <p className="text-sm text-gray-600">Create platform-wide announcements</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/admin/system-logs">
            <Card className="bg-white border-gray-200 hover:border-emerald-300 transition-colors cursor-pointer h-full">
              ...
              <CardContent>
                <p className="text-sm text-gray-600">View audit trails and system activity</p>
              </CardContent>
            </Card>
          </Link>
        </div>
