...
// Admin page to manage RLHF questions
...
export default function AdminRLHFPage() {
  ...
  async function createQuestion() {
    ...
    setSaving(true);
    const { error } = await supabaseAdmin.from("rlhf_questions").insert({
  ...
  async function deleteQuestion(id: string) {
    ...
    await supabaseAdmin.from("rlhf_questions").delete().eq("id", id);
    flash("Deleted");
    load();
  }
      ...
      <div style={{ background: BG }} className="min-h-screen">
        ...
        {creating && (
          <div
            ...
            style={{ background: SURFACE, border: `1px solid ${C}40` }}
          >
                      ...
                      <div className="flex items-start justify-between gap-4 mb-3">
                        ...
                        <div className="flex gap-1.5 shrink-0">
                          <button
                            ...
                            className="w-7 h-7 rounded-lg flex items-center justify-center border border-slate-700 text-slate-500 hover:text-white hover:border-slate-500 transition-all"
                          >
                            <Edit2 size={11} />
                          </button>
                          <button
