...
const FAQS = [
  ...
  },
  {
    ...
    a: "Returns are based on actual enterprise GPU demand. We do not promise fixed percentages—your earnings depend on real workload allocation from our 180+ enterprise clients. Historical data shows consistent 0.13% daily accrual, but market conditions vary. All participants should carefully review our terms and only invest capital they can afford to lock for their selected contract term.",
  },
  {
...
const STATS = [
  ...
  { value: 0.13, suffix: "%", label: "Daily Accrual Rate" },
];
...
const FEATURES = [
  {
    ...
    desc: "0.13% daily returns credited to your dashboard every 60 seconds. Transparent, real-time tracking of your GPU node's earnings from enterprise AI workloads.",
  },
  {
    icon: Clock,
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 overflow-x-hidden">
      ...
      <div className="sr-only" aria-hidden="true">
        ...
        verified investors worldwide. UK FCA regulated. AML/KYC compliant. Fully
        transparent. Start earning from $5. 0.13% daily returns. Weekly
        withdrawals. Secure blockchain payments. omnitaskpro.online - GPU
        computing investment platform
      </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full text-center px-4 sm:px-6">
          ...
          <p className="text-sm sm:text-lg md:text-xl text-slate-400 mb-6 sm:mb-10 md:mb-14 max-w-3xl mx-auto leading-relaxed text-balance">
            Invest in GPU node plans and earn 0.13% daily from real enterprise
            AI workloads. Supported by Fortune 500 companies and leading AI
            research institutions. Start from $5.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 max-w-4xl mx-auto">
            {[
              ...
              { label: "Daily Return Rate", value: "0.13%" },
            ].map(({ label, value }) => (
              <div
                key={label}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {[
              ...
              },
              {
                step: 4,
                title: "Earn Daily",
                desc: "Your node activates and begins accruing 0.13% daily returns. Withdraw any time (subject to term).",
                icon: TrendingUp,
              },
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            <div>
              ...
              <p className="text-slate-400 text-sm sm:text-lg mb-6 sm:mb-8 leading-relaxed">
                All plans accrue at 0.13% daily, with contract terms offering
                higher projected returns for committed capital. Flexible rolling
                plans available for maximum liquidity.
              </p>
              <div className="space-y-3 sm:space-y-4">
                {[
                  "Foundation Node: $5 minimum",
                  "Flexible & fixed 6/12/24-month terms",
                  "0.13% daily accrual rate guaranteed",
            ...
            <div className="bg-slate-900/60 border border-slate-800 rounded-2xl overflow-hidden">
              <div className="bg-slate-800/80 px-6 py-4 border-b border-slate-700">
                ...
                <p className="text-slate-500 text-sm mt-1">
                  Based on 0.13% daily accrual rate
                </p>
              </div>
              <div className="p-6 space-y-0">
                {[
                  { term: "Flexible Rolling", range: "$5 – continuous" },
                  { term: "6-Month Contract", range: "52% – 93% projected" },
                  { term: "12-Month Contract", range: "130% – 250% projected" },
                  {
                    term: "24-Month Contract",
                    range: "800% – 1,200% projected",
                  },
                ].map(({ term, range }, i) => (
                  <div
                    key={term}
