    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 text-lg">Join OmniTask Pro today</p>
        </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          {/* Sign in link */}
          <Link href="/auth/signin" className="w-full inline-block">
            <button className="w-full bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 hover:border-emerald-500/50 text-emerald-400 font-semibold py-3 rounded-lg transition-all flex items-center justify-center gap-2 group">
              Sign In
