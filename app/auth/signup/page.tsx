        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="mb-6 sm:mb-8 flex justify-center">
            <div 
              ...
              style={{
                backgroundImage: 'url(https://hebbkx1anhila5yf.public.blob.vercel-storage.com/app-logo-4J6JowMZjzav2QBIZKHi3xeHIL9Toq.png)',
          ...
          <h1 className="text-2xl sm:text-4xl font-black text-white mb-2 sm:mb-3">Create Account</h1>
          <p className="text-slate-400 text-sm sm:text-lg">Join OmniTask Pro today</p>
        </div>
